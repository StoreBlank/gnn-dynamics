...
from utils import pad, pad_torch, extract_kp_single_frame, fps_rad_idx
...
class DynDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        for i in range(len(pair)):
            ...
            obj_kp, static_tool_kp, dynamic_tool_kp = extract_kp_single_frame(dataset_config['data_dir'], episode_idx, frame_idx)
